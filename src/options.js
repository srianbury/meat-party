...
function options() {
  ...
  function controlsOptions() {
    ...
    add([
        ...
        text(playerControls[selectedPlayer].up),
    ]); 
    ...
    add([
        ...
        text(playerControls[selectedPlayer].down),
    ]); 
    ...
    add([
        ...
        text(playerControls[selectedPlayer].right),
    ]); 
    ...
    add([
        ...
        text(playerControls[selectedPlayer].left),
    ]); 
    ...
    add([
        ...
        text(playerControls[selectedPlayer].attack),
    ]); 
